# -*- coding: utf-8 -*-
"""
Created on Fri May 24 10:14:50 2024

@author: Coenraad Reichel
"""
...
model = pickle.load(open('C:/Users/Coenraad Reichel/OneDrive - Eduvos/Documents/Eduvos Honours/ITDAA4-12/Project/Final Code/Trained_model.sav', 'rb'))
...
def heart_predict(patient_data):
    ...
    if (prediction[0] == 0):
        return 'Patient Heart is Healthy'
    else:
        return 'Heart is Unhealthy'
